...
MOCK_ARP_DATA = """
IP address       HW type     HW address           Flags Mask            Iface
...
class TestScanner(unittest.TestCase):
    ...
    def test_scan_network_primary_success(self, MockEdgeMaxScanner):
        # Mock the EdgeMaxScanner instance and its methods
        mock_scanner_instance = MockEdgeMaxScanner.return_value
        mock_scanner_instance.get_arp_table.return_value = MOCK_ARP_DATA
        mock_scanner_instance.get_dhcp_leases.return_value = MOCK_LEASES_DATA
        ...
        mock_scanner_instance.close.assert_called_once()
